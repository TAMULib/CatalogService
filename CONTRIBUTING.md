...
Though CatalogService is developed and maintained by Texas A&M University Libraries, we welcome community contributions.
Involvement in CatalogService can take many forms:

<div align="right">(<a href="#readme-top">back to top</a>)</div>

## Using

Deploying CatalogService and trying it out at your own institution is itself a way of contributing to the development process.
...
Once you are using CatalogService the creation of new issues through GitHub is a major method of contribution towards CatalogService development.
...
Each *PR* will need to be reviewed by a CatalogService developer.
...
If you have any additional questions please contact the CatalogService developers at [helpdesk@library.tamu.edu][helpdesk-email].
